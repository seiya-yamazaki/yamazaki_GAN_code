...
def run(EPOCHS=10000, BATCHSIZE=64, SONGSIZE=128, DISSTEP=1, GENSTEP=1, NUMBERS=0):
    ...
    for k in range(1, EPOCHS + 1):
        ...
        for dis_step in range(DISSTEP):
            ...
            A_dis_of_songA = birdA.dis_song(songA)
            A_dis_of_songB = birdA.dis_song(songB)
        ...
        print k, loss_disA.data, A_dis_of_songB[0], A_dis_of_songA[0]

        f.write("{} {} {} {} {} {}\n".format(k, loss_disA.data, imitate_loss_genB, imitated_loss_genA,
                                             A_dis_of_songB[0].data[0], A_dis_of_songA[0].data[0]))
